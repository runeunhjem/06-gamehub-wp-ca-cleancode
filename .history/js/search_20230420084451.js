...
setTimeout(() => {
  if (searchQuery) {
    ...
    filteredGames.forEach((game) => {
      ...
      console.log("filteredGames.length is: ", filteredGames.length);
      console.log("games.length is: ", filteredGames.length);
      ...
      console.log("searchWord.length is: ", searchWord.length);
      if(searchWord.length === 0) {
        productsElement.textContent = `Games with ${searchWord} in the title: ${games.length}`;
      } else {
    ...
    searchForm.addEventListener("submit", function (event) {
      ...
      filteredGames.forEach((game) => {
        ...
        <div class="container game-cards" data-filter="${game.platform}-${game.type}">
          <div class="items ${game.itemName}">
            ...
            <div class="price psnright">
              ...
              <span class="currentPrice price">${game.currentPrice}</span>
            </div>
            <div class="price__before psnright">
              <span class="dollar yellow">.</span>${game.beforePrice}
            </div>
        ...
        const productsElement = document.querySelector(".number-of-products");
        productsElement.innerText = `Number of games: ${filteredGames.length}`;
